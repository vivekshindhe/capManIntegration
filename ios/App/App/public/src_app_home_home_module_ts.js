(self["webpackChunknativeSdkManualIntegration"] = self["webpackChunknativeSdkManualIntegration"] || []).push([["src_app_home_home_module_ts"],{
...
/* harmony import */ var _CheckoutPluginConn__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../CheckoutPluginConn */ 6850);
    ...
    payWithRazorpay() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
            const options = {
                ...
                prefill: {
                    name: 'Pratik',
                    email: 'payment@superfoodscompany.in',
                    contact: '8851950999'
                },
                notes: {
                    address: 'Kumar City , Kalyanbi Nagar , Pune,Pune,India-411048'
                }
            };
            _CheckoutPluginConn__WEBPACK_IMPORTED_MODULE_2__.default.addListener("PAYMENT_SUCCESS", (ret) => {
                alert("Success: " + ret['value']);
            });
            _CheckoutPluginConn__WEBPACK_IMPORTED_MODULE_2__.default.addListener('PAYMENT_FAILED', (res) => {
                alert("failed " + res['code']);
            });
            const res = yield _CheckoutPluginConn__WEBPACK_IMPORTED_MODULE_2__.default.startPayment(options);
        });
    }
};
